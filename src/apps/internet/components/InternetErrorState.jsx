...
export default function InternetErrorState({ onRetry }) {
  return (
    ...
    >
      <p className="font-display text-[11px] tracking-(--os-display-tracking) text-os-ink-soft">
        INTERNET
      </p>
      ...
      <p className="max-w-60 font-mono text-[10px] leading-relaxed text-os-ink-soft">
        The website couldn't be displayed inside BrowserOS Internet. Some sites
        don't allow this, or the address may be unreachable.
      </p>
      <button
        type="button"
        onClick={onRetry}
