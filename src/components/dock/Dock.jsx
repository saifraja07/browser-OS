...
export default function Dock() {
  ...
  return (
    <motion.div
      ...
      className="os-dock rounded-[12px] pixel-cut fixed bottom-4 left-1/2 z-[var(--z-navbar)] flex -translate-x-1/2 items-end gap-[var(--os-dock-gap)] border-[length:var(--os-border-width)] border-os-border-strong bg-os-surface/90 px-4 py-2.5 backdrop-blur-sm shadow-os-window"
